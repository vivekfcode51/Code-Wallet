...
const WithdrawalRequest = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        account_id: selectedBankId, // 👈 selected bank id
        user_id: userId, // 👈 from localStorage
        withdraw_method: activeModal, // 👈 1 = TRC20, 2 = BEP20
      ...
      if (res.data.success) {
        toast.success(res.data.message || "Withdraw request submitted successfully.");
        setSelectedAmount("");
        setUsdtAmount("");
