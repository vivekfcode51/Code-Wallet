  ...
  return (
    <div className="bg-white dark:bg-richblack-900 rounded-lg p-6 shadow-sm">
      <div className="flex items-center mb-6">
        <User className="w-5 h-5 mr-2 font-bold text-gray-600 dark:text-richblack-25" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="mt-6 flex justify-end">
          {/* <Link to="/edit-profile"> */}
            <button onClick={()=>setActiveTab("edit-profile")} className="flex items-center mb-2 rounded-2xl p-2 border border-gray-200 dark: bg-yellow-50 cursor-pointer">
